---
title: Controller - IKEA E2201 RODRET On/Off Switch & Dimmer
description: Controller automation for executing any kind of action triggered by the provided IKEA E2201 RODRET On/Off Switch & Dimmer. Supports deCONZ, ZHA, Zigbee2MQTT.
---
...
- On button long press -> Brightness up (continuous, until release)
- On button double press -> Color up
- Off button short press -> Turn off
- Off button long press -> Brightness down (continuous, until release)
- Off button double press -> Color down

#### Mapping #2

- On button short press -> Brightness up
- On button long press -> Brightness up (continuous, until release)
- On button double press -> Turn on
- Off button short press -> Brightness down
- Off button long press -> Brightness down (continuous, until release)
- Off button double press -> Turn off
...
- On button short press -> Volume up
- On button long press -> Volume up (continuous, until release)
- On button double press -> Next track
- Off button short press -> Volume down
- Off button long press -> Volume down
- Off button double press -> Play/Pause
...
- On button short press -> Open cover
- On button long press -> Open the cover tilt
- Off button short press -> Close cover
- Off button long press -> Close the cover tilt
- Off button double press -> Stop cover and cover tilt
